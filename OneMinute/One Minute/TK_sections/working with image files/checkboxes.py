...
root.iconbitmap(
    bitmap='C:/Users/HP/Documents/malo\'s/download.ico')  # Always use front-slash when including a file path
...
def teams():
    my_label = Label(root,
                     text=var.get()).pack()  # Var_sth.get() is used to get the information gotten from clicking the checkbox as set by the creator
